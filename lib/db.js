...
module.exports = {
  ...
  addHostedFormat({ campaign_id, format_name, width, height, r2_prefix, cdn_url, tag_html }) {
    return db.prepare(`
      INSERT INTO hosted_formats (campaign_id, format_name, width, height, r2_prefix, cdn_url, tag_html)
      VALUES (?, ?, ?, ?, ?, ?, ?)
    `).run(campaign_id, format_name, width, height, r2_prefix, cdn_url, tag_html);
  },
