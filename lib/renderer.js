...
<header class="header">
  ...
  <div style="font-size:14px;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">${escHtml(campaignName)}</div>
  <div style="font-size:11px;color:var(--text-3);">${escHtml(generatedAtFormatted)}</div>
  ...
  <div style="display:flex;gap:12px;align-items:center;font-size:12px;">
    <a href="/" style="color:var(--text-2);text-decoration:none;">Previews</a>
    <a href="/admin" style="color:var(--text-2);text-decoration:none;">Admin</a>
    <a href="/login" style="color:var(--accent);text-decoration:none;font-weight:600;">Log ind</a>
  </div>
</header>
