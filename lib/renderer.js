...
function generatePreviewHtml({ id, campaignName, clientName, banners, zuuviUrl, theme }) {
  ...
  // Theme CSS variable overrides — all derived from 3 base colors
  const themeVars = theme ? `
    --accent: ${theme.accent_color};
    --accent-2: ${theme.accent_color};
    --accent-dim: color-mix(in srgb, ${theme.accent_color} 18%, transparent);
    --bg: ${theme.bg_color};
    --surface: color-mix(in srgb, ${theme.bg_color} 85%, white 15%);
    --surface2: color-mix(in srgb, ${theme.bg_color} 75%, white 25%);
    --surface3: color-mix(in srgb, ${theme.bg_color} 65%, white 35%);
    --border: color-mix(in srgb, ${theme.bg_color} 60%, white 40%);
    --border2: color-mix(in srgb, ${theme.bg_color} 50%, white 50%);
