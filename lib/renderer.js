  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    :root {
      ...
      --header-h: 150px; --sidebar-w: 200px;
...
<header class="header">
  <a href="https://xo.dk" target="_blank" class="header-logo" style="text-decoration:none;">  
    ...
    <span class="logo-sub">${escHtml(campaignName)}</span>
  </a>
  ...
  <div class="header-stats">
    ...
    <a href="/admin" class="stat-pill" style="text-decoration:none;color:var(--text-2);">⚙️ Admin</a>
